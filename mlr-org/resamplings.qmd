...
library(mlr3misc)
library(data.table)
# FIXME: add mlr3spatiotempcv resampling methods after v2 release (man files were missing before)
# library(mlr3spatiotempcv)
requireNamespace("mlr3verse")

content = as.data.table(mlr3::mlr_resamplings)[, .(key, label, params, iters)]
content[, key := link_keys(key, prefix = "mlr_resamplings", format = "html")]
