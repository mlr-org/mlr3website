...
package_grid = function(content) {
  div(class = "grid grid-three",
    pmap(content, function(category, name, status, url, text, on_cran, ...) {
        ...
        # packages outside the mlr-org organization link to their own repository
        github_url = if (grepl("github.com", url, fixed = TRUE)) url else sprintf("https://github.com/mlr-org/%s", name)
        div(class = "grid__item",
          ...
          div(class = "grid__item-footer",
            ...
            a(class = "grid__link-footer", href = github_url, "aria-label" = "Go to Project Page", tags$i(class = "bi bi-github grid__icon-footer", title = "Github Project")),
...
content = rowwise_table(
    ...
    "optimization",    "mlr3automl",        "stable",       "https://github.com/mlr-org/mlr3automl/",     "Automated machine learning",
    ...
    "analysis",        "mlr3resampling",    "stable",       "https://github.com/tdhock/mlr3resampling",   "Resampling algorithms for comparing data subsets",
    ...
    "tasks",           "mlr3cmprsk",        "experimental", "https://mlr3cmprsk.mlr-org.com/",            "Machine learning for competing risks analysis",
    "tasks",           "mlr3survival",      "planned",      "https://mlr3survival.mlr-org.com/",          "Machine learning for survival analysis",
    ...
    "other",           "survdistr",         "stable",       "https://survdistr.mlr-org.com/",             "Containers for the prediction outputs of survival models",
