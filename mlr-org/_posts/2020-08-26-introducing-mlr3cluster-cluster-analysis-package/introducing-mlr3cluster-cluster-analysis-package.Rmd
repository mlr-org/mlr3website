...
```{r introducing-mlr3cluster-cluster-analysis-package-001, eval=FALSE}
...
```{r introducing-mlr3cluster-cluster-analysis-package-002}
library(mlr3)
library(mlr3cluster)
...
```{r introducing-mlr3cluster-cluster-analysis-package-003}
...
```{r introducing-mlr3cluster-cluster-analysis-package-004}
...
```{r introducing-mlr3cluster-cluster-analysis-package-005}
...
```{r introducing-mlr3cluster-cluster-analysis-package-006}
task = mlr_tasks$get("usarrests")
learner = mlr_learners$get("clust.kmeans")
learner$param_set
...
```{r introducing-mlr3cluster-cluster-analysis-package-007}
task = mlr_tasks$get("usarrests")
...
```{r introducing-mlr3cluster-cluster-analysis-package-008}
...
```{r introducing-mlr3cluster-cluster-analysis-package-009, eval=FALSE}
install.packages("mlr3viz")
```


```{r introducing-mlr3cluster-cluster-analysis-package-010= TRUE, results = FALSE, message = FALSE, warning = FALSE}
library(mlr3viz)
...
```{r introducing-mlr3cluster-cluster-analysis-package-011= TRUE, results = FALSE, message = FALSE, warning = FALSE}
autoplot(preds, task, type = "pca", frame = TRUE)
```

You can also easily visualize dendrograms:

```{r introducing-mlr3cluster-cluster-analysis-package-012= TRUE, results = FALSE, message = FALSE, warning = FALSE}
task = mlr_tasks$get("usarrests")
