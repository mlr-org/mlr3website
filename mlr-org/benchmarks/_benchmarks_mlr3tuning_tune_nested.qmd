...
#| echo: false
#| column: body-outset
#| fig-cap: !expr sprintf("Median runtime of `tune_nested()` with models trained for %i ms depending on the mlr3tuning version. The dashed line indicates the total training time of the models. Error bars represent the median absolute deviation of the runtime.", .model_time)
