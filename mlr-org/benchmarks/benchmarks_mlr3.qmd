...
Instead of using real models, we simulate the train and predict time of models by sleeping for 1, 10, 100, and 1000 ms.
...
The `$predict_newdata()` method is slower than `$predict()` because the data is converted to a task.
...
data_runtime = setDT(dbReadTable(con, "mlr3_train_runtime"))[, list(model_time, task, renv_project, median_runtime, mad_runtime, k)]
data_runtime[, renv_project := gsub("mlr3/default/snapshots/", "", renv_project)]
data_runtime = data_runtime[snapshot, on = "renv_project"]
setorderv(data_runtime, c("task", "model_time", "mlr3"), order = c(1, 1, -1))
...
{{< include _benchmarks_mlr3_train.qmd >}}
...
data_runtime = setDT(dbReadTable(con, "mlr3_predict_runtime"))[, list(model_time, task, renv_project, median_runtime, mad_runtime, k)]
data_runtime[, renv_project := gsub("mlr3/default/snapshots/", "", renv_project)]
...
{{< include _benchmarks_mlr3_predict.qmd >}}
...
```{r}
#| include: false
data_runtime = setDT(dbReadTable(con, "mlr3_predict_newdata_runtime"))[, list(model_time, task, renv_project, median_runtime, mad_runtime, k)]
data_runtime[, renv_project := gsub("mlr3/default/snapshots/", "", renv_project)]
data_runtime = data_runtime[snapshot, on = "renv_project"]
setorderv(data_runtime, c("task", "model_time", "mlr3"), order = c(1, 1, -1))
data_runtime = data_runtime[, -c("renv_project")]
...
{{< include _benchmarks_mlr3_predict_newdata.qmd >}}
...
```{r}
#| include: false
data_runtime = setDT(dbReadTable(con, "mlr3_predict_newdata_fast_runtime"))[, list(model_time, task, renv_project, median_runtime, mad_runtime, k)]
data_runtime[, renv_project := gsub("mlr3/default/snapshots/", "", renv_project)]
data_runtime = data_runtime[snapshot, on = "renv_project", nomatch = 0]
setorderv(data_runtime, c("task", "model_time", "mlr3"), order = c(1, 1, -1))
data_runtime = data_runtime[, -c("renv_project")]
...
{{< include _benchmarks_mlr3_predict_newdata_fast.qmd >}}
