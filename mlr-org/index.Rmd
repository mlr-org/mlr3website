...
content = rowwise_table(
  ...
  "Basic Machine Learning", "pen",      "https://website.mlr-org.com/gallery/",                                                                            "Basic machine learning on the Pima Indians Diabetes data set", list(list("Load a ML algorithm", "Create a task", "Perform resampling")),
  "Hyperparameter Tuning",  "sliders",  "https://website.mlr-org.com/gallery/2022-03-08-hyperparameter-tuning-on-the-palmer-penguins-data-set/index.html", "Hyperparameter tuning on the Palmer Penguins data set",        list(list("Specify a Tuning space", "Tune an XGBoost model", "Interpret the results"))
)
