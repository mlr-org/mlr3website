...
content = rowwise_table(
    ...
    "stack",        "Quick parallelization with the `future` package.",       "https://futureverse.org/",
...
content = rowwise_table(
    ~name,                ~image,                 ~url,                              ~text,
    "Classification",     "images/air.jpg",       "https://mlr3gallery.mlr-org.com/",   "Basic example",
    "Tuning",             "images/fire.jpg",       "https://mlr3gallery.mlr-org.com/",   "Choosing a set of optimal hyperparameters",
    "Feature Selection",  "images/wave.jpg",       "https://mlr3gallery.mlr-org.com/",   "Selecting a set of optimal features",
    "Pipelines",          "images/soil.jpg",       "https://mlr3gallery.mlr-org.com/",   "Dataflow programming"
)
