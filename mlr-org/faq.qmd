...
2. **Use Factor Encoding**: Incorporate a preprocessing step in your data pipeline (e.g. see [mlr_pipeops_encode])(https://mlr3pipelines.mlr-org.com/reference/mlr_pipeops_encode.html) to make sure factors are one-hot encoded, alleviating problems that may arise from factor levels that incorporate strange symbols.
