  ...
  div(class = "grid-container-package",
    pmap(content, function(category, name, status, url, text, on_cran, ...) {
        ...
        div(class = "grid-item-package",
          ...
          p(paste0(text, ".")),
          div(id = "bottom",
            if (has_homepage) a(href = url, tags$i(class = "bi bi-house", title = "Homepage")),
            if (has_homepage) a(href = paste0(url, "reference/"), tags$i(class = "bi bi-question-circle", title = "Reference Manual")),
            a(href = sprintf("https://github.com/mlr-org/%s", name), tags$i(class = "bi bi-github", title = "Github Project")),
            if (on_cran) a(href = sprintf("https://cran.r-project.org/package=%s", name), tags$i(class = "fab fa-r-project", title = "CRAN Website"))
