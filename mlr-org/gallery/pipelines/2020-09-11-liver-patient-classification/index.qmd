...
```{r index-005, echo=FALSE, fig.width = 8, fig.height = 4}
...
```{r index-006, echo=FALSE, fig.width = 10, fig.height = 10}
# Metric variables
...
```{r index-007, echo=FALSE, warning=FALSE, fig.width = 8, fig.height = 4}
...
```{r index-008, echo=FALSE, warning=FALSE, fig.width=10, fig.height=10}
...
```{r index-009, echo=FALSE, warning=FALSE, fig.width = 10, fig.height = 10}
...
```{r index-010, echo=FALSE, fig.width = 12, fig.height = 12}
# Correlation heatmap
...
```{r index-018, echo = TRUE, results = 'hide'}
...
```{r index-021, echo=FALSE, fig.height = 6, fig.width = 12}
...
```{r index-022, echo=FALSE, out.width='85%', fig.align="center"}
# Plotting ROC curves
# FIXME:
...
```{r index-024, echo=FALSE, fig.width = 10, fig.height = 10, eval=FALSE}
# FIXME:
...
```{r index-025, echo=FALSE, fig.width = 10, fig.height = 10, eval=FALSE}
# FIXME:
...
```{r index-026, echo=FALSE, out.extra='', eval=FALSE}
# FIXME:
