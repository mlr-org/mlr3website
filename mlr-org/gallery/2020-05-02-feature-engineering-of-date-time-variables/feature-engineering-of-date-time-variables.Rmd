...
```{r feature-engineering-of-date-time-variables-003, message=FALSE}
library(mlr3verse)
...
saveRDS(rr_ranger, here::here("data/rr_ranger.rda"))
```

```{r feature-engineering-of-date-time-variables-014, echo = FALSE}
rr_ranger = readRDS(here::here("data/rr_ranger.rda"))
```

```{r feature-engineering-of-date-time-variables-015, echo = FALSE}
table_responsive(rr_ranger$score(msr("regr.mse"))[, .(iteration, task_id, learner_id, resampling_id, regr.mse)])
```
...
saveRDS(rr_graph_learner, here::here("data/rr_graph_learner.rda"))
```

```{r feature-engineering-of-date-time-variables-022, echo = FALSE}
rr_graph_learner = readRDS(here::here("data/rr_graph_learner.rda"))
```
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2020-05-02-feature-engineering-of-date-time-variables/feature-engineering-of-date-time-variables_files/figure-html5/feature-engineering-of-date-time-variables-002-1.png",
