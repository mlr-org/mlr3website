...
saveRDS(rr_ranger, "rr_ranger.rda")
```

```{r feature-engineering-of-date-time-variables-014, echo = FALSE}
rr_ranger = readRDS("rr_ranger.rda")
```
...
saveRDS(rr_graph_learner, "rr_graph_learner.rda")
```

```{r feature-engineering-of-date-time-variables-022, echo = FALSE}
rr_graph_learner = readRDS("rr_graph_learner.rda")
```
