...
```{r target-transformations-via-pipelines-002, message=FALSE}
library(mlr3)
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2020-06-15-target-transformations-via-pipelines/workflow.svg",
  destfile = "thumbnail.svg"
)
```
