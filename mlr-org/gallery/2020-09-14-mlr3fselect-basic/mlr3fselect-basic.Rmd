...
table_responsive(as.data.table(instance$archive, exclude_columns = c("runtime_learners", "resample_result", "uhash")))
```
...
table_responsive(as.data.table(instance$archive, exclude_columns = c("runtime_learners", "timestamp", "batch_nr", "resample_result", "uhash")))
```
...
table_responsive(extract_inner_fselect_results(rr))
```
...
table_responsive(extract_inner_fselect_archives(rr))
```
