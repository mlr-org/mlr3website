...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-001, message = FALSE}
library(mlr3verse)
```
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-002}
set.seed(7832)
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-005, eval = FALSE}
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-006}
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-013, eval = FALSE}
autoplot(instance, type = "surface", cols_x = c("cost", "gamma"),
  learner = lrn("regr.km"))
```

```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-014, echo = FALSE}
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-015, eval = FALSE}
learner = lrn("classif.svm", type = "C-classification", kernel = "radial")
learner$param_set$values$cost = to_tune(0.1, 10)
learner$param_set$values$gamma = to_tune(0, 5)
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-016}
learner = lrn("classif.svm", type = "C-classification", kernel = "radial")
...
```{r 2021-03-09-practical-tuning-series-tune-a-support-vector-machine-035, eval = FALSE}
learner = lrn("classif.svm", type = "C-classification")
learner$param_set$values$cost = to_tune(p_dbl(1e-5, 1e5, logscale = TRUE))
learner$param_set$values$gamma = to_tune(p_dbl(1e-5, 1e5, logscale = TRUE))
learner$param_set$values$kernel = to_tune(c("polynomial", "radial"))
