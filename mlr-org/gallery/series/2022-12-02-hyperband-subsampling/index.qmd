...
The first part can be found here [Hyperband Series - Iterative Training](/gallery/series/2022-12-01-hyperband-xgboost).
...
We load the Hyperband `r ref("Tuner")` and set `eta = 3`.
