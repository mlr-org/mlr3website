...
- [Part I - Basics](https://mlr-org.com/gallery/series/2020-03-11-basics-german-credit/)
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-001, message=FALSE, warning=FALSE}
library("mlr3verse")
library("data.table")
library("ggplot2")
```
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-002}
set.seed(7832)
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-003, message=FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-005, eval = FALSE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-007, error=TRUE}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-009, results = 'hide'}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-010, echo = FALSE}
#| column: page
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-020, fig.width=10, fig.height=10}
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-021, warning=FALSE}
grid = benchmark_grid(
  task = task,
  learner = list(
    graph_stack,
...
```{r 2020-03-11-mlr3pipelines-tutorial-german-credit-022, echo = FALSE}
