...
The number of boosting iterations increases the time to train a model and is therefore suitable as a fidelity parameter.
...
* [Hyperband Series - Data Set Subsampling](/gallery/series/2022-12-02-hyperband-subsampling)
* Hyperband Series - Large-Scale Experiments (Work in progress)
...
The colors in @tbl-schedule indicate a parallelly evaluated batch.
