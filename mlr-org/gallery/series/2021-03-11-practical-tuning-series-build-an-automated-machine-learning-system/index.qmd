...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-001, message = FALSE}
library(mlr3verse)
```
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-002}
set.seed(7832)
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-005, fig.width=10, fig.height=10}
graph =
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-006}
learners = list(
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-008, fig.width=10, fig.height=10}
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-009}
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-014, fig.width=12, fig.height=4}
#| column: page
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-015}
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-017, eval = FALSE}
extract_inner_tuning_results(rr)
```

```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-018, echo = FALSE}
#| column: page
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-019}
...
```{r 2021-03-11-practical-tuning-series-build-an-automated-machine-learning-system-021, eval = FALSE}
graph_learner = as_learner(graph)
graph_learner$param_set$values$branch.selection =
  to_tune(c("kknn", "svm", "ranger"))
graph_learner$param_set$values$kknn.k =
