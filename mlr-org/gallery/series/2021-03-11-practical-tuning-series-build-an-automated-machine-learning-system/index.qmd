...
description: |
  Implement a simple automated machine learning.
categories:
  - tuning
  - resampling
  - mlr3pipelines
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-015}
instance = tune(
...
```{r practical-tuning-series-build-an-automated-machine-learning-system-026}
