...
```{r practical-tuning-series-tune-a-support-vector-machine-002, include=FALSE}
...
saveRDS(instance, here::here("data/instance_2.rda"))
```

```{r practical-tuning-series-tune-a-support-vector-machine-025, echo = FALSE}
instance = readRDS(here::here("data/instance_2.rda"))
```
...
table_responsive(as.data.table(instance$archive)[, .(cost, gamma, x_domain_cost, x_domain_gamma)])
```
...
```{r practical-tuning-series-tune-a-support-vector-machine-035, echo = FALSE}
saveRDS(instance, here::here("data/instance_3.rda"))
```

```{r practical-tuning-series-tune-a-support-vector-machine-036, echo = FALSE}
instance = readRDS(here::here("data/instance_3.rda"))
```
...
```{r practical-tuning-series-tune-a-support-vector-machine-041, echo = FALSE}
saveRDS(rr, here::here("data/rr_1.rda"))
```

```{r practical-tuning-series-tune-a-support-vector-machine-042, echo = FALSE}
rr = readRDS(here::here("data/rr_1.rda"))
```
...
```{r practical-tuning-series-tune-a-support-vector-machine-044, echo = FALSE}
#| column: page
table_responsive(extract_inner_tuning_results(rr)[, .SD, .SDcols = !c("learner_param_vals", "x_domain")])
```
...
```{r practical-tuning-series-tune-a-support-vector-machine-048, echo = FALSE}
#| column: page
table_responsive(extract_inner_tuning_archives(rr, unnest = NULL, exclude_columns = c("resample_result", "uhash", "x_domain", "timestamp")))
```
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2021-03-09-practical-tuning-series-tune-a-support-vector-machine/practical-tuning-series-tune-a-support-vector-machine_files/figure-html5/practical-tuning-series-tune-a-support-vector-machine-019-1.png",
  destfile = "thumbnail.png"
)
```
