...
```{r 2020-02-01-tuning-multiplexer-002, message=FALSE}
library(mlr3verse)
library(mlr3tuning)
...
saveRDS(rr, here::here("data/rr.rda"))
```

```{r 2020-02-01-tuning-multiplexer-012, echo = FALSE}
rr = readRDS(here::here("data/rr.rda"))
```
...
```{r 2020-02-01-tuning-multiplexer-015, echo = FALSE}
#| column: page
DT::datatable(extract_inner_tuning_archives(rr, exclude_columns = c("uhash",  "resample_result")))
```
...
saveRDS(instance, here::here("data/instance.rda"))
```

```{r 2020-02-01-tuning-multiplexer-021, echo = FALSE}
instance = readRDS(here::here("data/instance.rda"))
```

```{r 2020-02-01-tuning-multiplexer-022, echo = FALSE}
#| column: page
DT::datatable(as.data.table(instance$archive, exclude_columns = c("uhash",  "resample_result")))
```
...
saveRDS(rr, here::here("data/rr_2.rda"))
```

```{r 2020-02-01-tuning-multiplexer-026, echo = FALSE}
rr = readRDS(here::here("data/rr_2.rda"))
```
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2020-02-01-tuning-multiplexer/2020-02-01-tuning-multiplexer_files/figure-html5/2020-02-01-tuning-multiplexer-023-1.png",
