...
```{r index-004, eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-006, eval=params$showsolution, base64encode=params$base64encode}
library("mlr3verse")
...
```{r index-008, eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-013, eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-015, eval=params$showsolution, base64encode=params$base64encode}
