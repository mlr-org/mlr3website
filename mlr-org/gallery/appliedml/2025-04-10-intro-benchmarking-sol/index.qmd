...
```{r index-006, eval=params$showsolution, base64encode=params$base64encode, message=FALSE}
...
```{r index-007, eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-009, eval=FALSE, message=FALSE}
# load the packages
library(mlr3)
