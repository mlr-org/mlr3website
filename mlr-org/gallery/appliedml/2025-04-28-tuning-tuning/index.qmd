...
<details>
  ...
  - We use the default performance measure (`msr("classif.ce")` for classification and `msr("regr.mse")` for regression)
...
```{r index-010, fig.width=15, fig.height=5, out.width="100%", eval = params$showsolution}
