...
```{r index-003, eval=params$showsolution, base64encode=params$base64encode}
library(mlr3)
...
```{r index-005, eval=params$showsolution, base64encode=params$base64encode}
library(rpart.plot)
...
```{r index-006, fig.width=15, fig.height=15, out.width="100%", eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-007, fig.width=15, fig.height=15, out.width="100%", eval=params$showsolution, base64encode=params$base64encode}
library(partykit)
...
```{r index-008, fig.width=15, fig.height=15, out.width="100%", eval=params$showsolution, base64encode=params$base64encode}
library(ggparty)
...
```{r index-010, eval=params$showsolution, base64encode=params$base64encode}
library(mlr3)
library(mlr3learners)
...
```{r index-011, eval=params$showsolution, base64encode=params$base64encode}
...
```{r index-014, eval=params$showsolution, base64encode=params$base64encode}
library(mlr3verse)
set.seed(31415L)
...
```{r index-016, eval=params$showsolution, base64encode=params$base64encode}
set.seed(31415L)
