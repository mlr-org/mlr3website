...
```{r index-008, eval = !params$showsolution, echo = FALSE, results='asis'}
cat("<!--")
```
...
# Set booster explicitly as the search space tunes tree-specific parameters:
xgb_ts$param_set$values$booster = "gbtree"
...
```{r index-012, eval = params$showsolution, results = 'hide'}
