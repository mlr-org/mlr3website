...
5. Initialize a `TuningInstanceBatchSingleCrit` object using `ti()` and the objects
...
`TuningInstanceBatchSingleCrit` as an input.
...
Inspect the tuned instance (of class `TuningInstanceBatchSingleCrit`, it was the input to `$optimize()`).
