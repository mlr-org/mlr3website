...
saveRDS(instance_grid, here::here("data/instance_grid.rda"))
```

```{r 2020-03-11-mlr3tuning-tutorial-german-credit-017, echo = FALSE}
instance_grid = readRDS(here::here("data/instance_grid.rda"))
```
...
saveRDS(instance_random, here::here("data/instance_random.rda"))
```

```{r 2020-03-11-mlr3tuning-tutorial-german-credit-026, echo = FALSE}
instance_random = readRDS(here::here("data/instance_random.rda"))
```
...
```{r 2020-03-11-mlr3tuning-tutorial-german-credit-028, echo = FALSE}
#| column: page
DT::datatable(#|
...
saveRDS(rr , here::here("data/resample_result.rda"))
```

```{r 2020-03-11-mlr3tuning-tutorial-german-credit-035, echo=FALSE}
rr = readRDS(here::here("data/resample_result.rda"))
```
...
```{r 2020-03-11-mlr3tuning-tutorial-german-credit-037, echo = FALSE}
...
```{r 2020-03-11-mlr3tuning-tutorial-german-credit-041, echo = FALSE}
#| column: page
DT::datatable(
...
```{r 2020-03-11-mlr3tuning-tutorial-german-credit-045, echo=FALSE}
#| column: page
perfdata = readRDS(here::here("data/randomsearch_3600.rds"))
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2020-03-11-mlr3tuning-tutorial-german-credit/2020-03-11-mlr3tuning-tutorial-german-credit_files/figure-html5/2020-03-11-mlr3tuning-tutorial-german-credit-021-1.png",
