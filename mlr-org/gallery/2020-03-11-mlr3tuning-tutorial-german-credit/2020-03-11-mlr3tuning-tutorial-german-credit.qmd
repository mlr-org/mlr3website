...
saveRDS(instance_grid, "instance_grid.rda")
```

```{r 2020-03-11-mlr3tuning-tutorial-german-credit-017, echo = FALSE}
instance_grid = readRDS("instance_grid.rda")
```
...
saveRDS(instance_random, "instance_random.rda")
```

```{r 2020-03-11-mlr3tuning-tutorial-german-credit-026, echo = FALSE}
instance_random = readRDS("instance_random.rda")
```
