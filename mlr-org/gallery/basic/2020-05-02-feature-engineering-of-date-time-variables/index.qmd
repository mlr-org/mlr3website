...
```{r index-001, echo=FALSE, fig.height=5.5, fig.width=10}
hours = 0:23
...
```{r index-007, echo = FALSE, message = FALSE}
library("ggplot2")
...
task$filter(setdiff(seq_len(task$nrow), validation_set))
```
...
```{r index-015, fig.width=8, fig.height=10}
