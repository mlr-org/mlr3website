...
```{r 2020-03-18-iris-mlr3-basics-002, message=FALSE}
library(mlr3verse)
...
```{r 2020-03-18-iris-mlr3-basics-012}
...
Note how after the loading the mlr3extralearners package, the dictionary increases in size.

```{r 2020-03-18-iris-mlr3-basics-015, message = FALSE}
nrow(as.data.table(mlr_learners)])
