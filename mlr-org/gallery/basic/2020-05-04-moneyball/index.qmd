...
```{r index-011, fig.width=10, fig.height=10}
...
```{r index-016, fig.width=10, fig.height=10}
...
```{r index-027, fig.width=10, fig.height=10}
...
#| column: page
vi = sort(graph_learner$model$regr.ranger$model$variable.importance, decreasing = TRUE)
DT::datatable(data.table(variable = names(vi), importance = unname(vi)))
```
