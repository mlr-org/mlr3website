...
```{r 2020-04-27-tuning-stacking-002, message=FALSE}
library(mlr3verse)
...
table_responsive(bmr$aggregate(msr("classif.auc"))[, .(nr, task_id, learner_id, resampling_id, iters, classif.auc)])
```
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2020-04-27-tuning-stacking/2020-04-27-tuning-stacking_files/figure-html5/2020-04-27-tuning-stacking-013-1.png",
