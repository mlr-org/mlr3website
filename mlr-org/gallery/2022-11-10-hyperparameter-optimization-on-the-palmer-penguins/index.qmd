...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-002}
#| column: body-outset
...
Among other packages, it loads the hyperparameter optimization package of the mlr3 ecosystem `r mlr_pkg("mlr3tuning")`.
...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-005}
#| column: body-outset
...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-006}
...
The package `r mlr_pkg("mlr3tuningspaces")` is a collection of search spaces for hyperparameter tuning from peer-reviewed articles.
...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-011}
instance = tune(
  method = "grid_search",
  task = tsk("penguins"),
...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-014}
...
```{r hyperparameter-tuning-on-the-palmer-penguins-data-set-019}
learner = lrn("classif.rpart")
