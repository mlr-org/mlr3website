...
```{r 2020-09-11-liver-patient-classification-003, message=FALSE}
library(mlr3verse)
library(dplyr)
library(tidyr)
...
```{r 2020-09-11-liver-patient-classification-024, echo=FALSE, fig.height = 6, fig.width = 12}
...
table_responsive(bmr$aggregate(list(
  msr("classif.auc"),
  msr("classif.sensitivity"),
  msr("classif.specificity"),
  msr("classif.fnr"),
...
```{r 2020-09-11-liver-patient-classification-027, echo=FALSE, fig.width = 10, fig.height = 10, eval=FALSE}
# FIXME:
...
```{r 2020-09-11-liver-patient-classification-028, echo=FALSE, fig.width = 10, fig.height = 10, eval=FALSE}
# FIXME:
...
```{r 2020-09-11-liver-patient-classification-029, echo=FALSE, out.extra='', eval=FALSE}
# FIXME:
