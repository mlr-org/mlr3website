...
The goal of `r ref_pkg("mlr3spatial")` is to simplify these tasks within the [mlr3 ecosystem](https://mlr-org.com/ecosystem.html).
As a practical example, we will perform a land cover classification for the city of Leipzig, Germany.
...
We assume that you are familiar with the [mlr3 ecosystem](https://mlr-org.com/ecosystem.html).
...
Land cover is the physical material or vegetation that covers the surface of the earth, including both natural and human-made features.
...
We will work with a Sentinel-2 scene of the city of Leipzig which consists of 7 bands with a 10 or 20m spatial resolution and an NDVI band.
