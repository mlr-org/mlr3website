...
saveRDS(tune1, here::here("data/tune1.rda"))
```

```{r tuning-a-complex-graph-017, echo = FALSE}
tune1 = readRDS(here::here("data/tune1.rda"))
```
...
#| include: false
utils::download.file(
  url = "https://mlr-org.com/gallery/2021-02-03-tuning-a-complex-graph/tuning-a-complex-graph_files/figure-html5/tuning-a-complex-graph-009-1.png",
