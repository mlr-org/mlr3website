...
description: |
  ...
  Cover photo by [USGS](https://unsplash.com/@usgs?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
author:
  - name: Marc Becker
...
```{r announcing-mlr3spatial-001, include=FALSE}
...
```{r announcing-mlr3spatial-002, include=FALSE}
library("stars")
```

```{r announcing-mlr3spatial-003}
library("mlr3")
library("mlr3spatial")
```
...
```{r announcing-mlr3spatial-004, error=TRUE}
...
```{r announcing-mlr3spatial-006, warning=FALSE}
