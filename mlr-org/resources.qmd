...
content = rowwise_table(
  ...
  "general", "Reference Manual", "question-circle", "packages.html", "Reference manuals (via package overview)",
...
* @pargent2022introduction: An Introduction to Machine Learning for Psychologists in R
