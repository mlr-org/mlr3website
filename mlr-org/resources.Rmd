...
More technical documentation can be found in the reference manual of the respective [packages](packages.html).
...
* @checkmate: library for argument checking and defensive programming
* @batchtools: parallelization framework for high-performance computing clusters, used via `r cran_pkg("future")` or `r gh_pkg("mlr-org/mlr3batchmark")`
