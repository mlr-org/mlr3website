...
content = rowwise_table(
    ...
    "general",    "Reference",         "question-circle", "packages.html",                                         "Reference manuals (via package overview)",
    ...
    "faq",        "FAQ",               "question-square", "https://github.com/mlr-org/mlr3/wiki/FAQ",              "Frequently Asked Questions",
    "faq",        "Stackoverflow",     "stack-overflow",  "https://stackoverflow.com/questions/tagged/mlr3",       "Questions on StackOverflow tagged with [mlr3]",
