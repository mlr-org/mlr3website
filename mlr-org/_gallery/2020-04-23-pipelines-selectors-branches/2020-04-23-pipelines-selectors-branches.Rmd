...
table_responsive(head(impute_missind$train(task_pima)[[1]]$data()))
```
...
table_responsive(head(imputer_missind_2$train(task_pima)[[1]]$data()))
```
...
table_responsive(head(imputer_missind_3$train(task_pima)[[1]]$data()))
```
