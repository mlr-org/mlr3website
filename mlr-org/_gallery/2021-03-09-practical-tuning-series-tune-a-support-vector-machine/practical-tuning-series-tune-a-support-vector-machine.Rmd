...
responsive_table(as.data.table(learner$param_set)[, c("id", "class", "lower", "upper", "nlevels"), with = FALSE])
```
...
responsive_table(as.data.table(instance$archive)[, .(cost, gamma, x_domain_cost, x_domain_gamma)])
```
...
responsive_table(extract_inner_tuning_archives(rr, unnest = NULL, exclude_columns = c("resample_result", "uhash", "x_domain", "timestamp")))
```
