...
responsive_table(as.data.table(knn$param_set)[, c("id", "class", "lower", "upper", "nlevels"), with = FALSE])
```
...
responsive_table(head(as.data.table(instance_grid$archive, unnest = NULL, exclude_columns = c("x_domain", "uhash", "resample_result"))))
```
...
responsive_table(as.data.table(instance_random$archive, exclude_columns = c("uhash", "resample_result")))
```
...
responsive_table(extract_inner_tuning_results(rr)[, .SD, .SDcols = !c("learner_param_vals", "x_domain")])
```
...
responsive_table(extract_inner_tuning_archives(rr, exclude_columns = c("uhash", "resample_result")))
```
