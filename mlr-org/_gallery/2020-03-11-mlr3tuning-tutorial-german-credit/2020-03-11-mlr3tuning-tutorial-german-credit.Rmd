...
table_responsive(as.data.table(knn$param_set)[, c("id", "class", "lower", "upper", "nlevels"), with = FALSE])
```
...
table_responsive(head(as.data.table(instance_grid$archive, unnest = NULL, exclude_columns = c("x_domain", "uhash", "resample_result"))))
```
...
table_responsive(as.data.table(instance_random$archive, exclude_columns = c("uhash", "resample_result")))
```
