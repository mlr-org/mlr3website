...
The `early_stopping_set` parameter controls which set is used monitoring the performance.
...
This results in three different optimal number of boosting rounds for one hyperparameter configuration when applying a 3-fold cross-validation.
...
We can also use the `r ref("AutoTuner")` get a tuned XGBoost model.
