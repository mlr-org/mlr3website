...
When using early stopping, the performance of the model is monitored on a validation set and the training is stopped when performance is decreasing in a specific number of iterations.
...
The `partition()` function splits the rows ids of the task into two sets.
