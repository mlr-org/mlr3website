...
responsive_table(as.data.table(l$param_set)[, c("id", "class", "lower","upper","nlevels"), with = FALSE])
```
...
responsive_table(as.data.table(l2$param_set)[, c("id", "class", "lower","upper","nlevels"), with = FALSE])
```
...
responsive_table(bmr$aggregate(list(msr("classif.ce"), msr("classif.fnr")))[,.SD, .SDcols = !c("resample_result")])
```
